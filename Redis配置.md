...
```
[root@iZbp136jwir14u4w7i4o74Z ~]# cat /etc/redis
redis.conf           redis-sentinel.conf
[root@iZbp136jwir14u4w7i4o74Z ~]# rpm -ql redis
...
```
[root@iZbp136jwir14u4w7i4o74Z ~]# cat /etc/redis.conf
